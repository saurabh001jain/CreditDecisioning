...
def UseConfig(spark: SparkSession):
    ...
    os.system(
        'wget https://raw.githubusercontent.com/atbida/terraform-databricks-lakehouse-blueprints/main/industry/fsi/data/TransUnionFICO2018 -O /dbfs/Prophecy/${user_email}/testconfig.xml'
    )
